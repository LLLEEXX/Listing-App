...
export default function BuyLot({}) {
  ////////////////////////////////Variables
      ...
      <Grid container sx={{ gap: 2 }}>
        <Grid item md={3} xs={12}>
          ...
          <Select
            ...
            id="lotPref"
            fullWidth
            value={propertyState.buyLot.PropLotPref}
        ...
        <Grid item md={3} xs={12}>
          ...
          <Select
            ...
            id="lotPref"
            fullWidth
            value={propertyState.buyLot.PropLotUse}
            onChange={handleInput}
            name="PropLotUse"
          >
        ...
        <Grid item md={3.5} xs={12}>
          ...
          <OutlinedInput
            ...
            value={propertyState.buyLot.PropSize}
            onChange={handleInput}
            name="PropSize"
          />
          {propertyState.buyLot.lot_errs.PropSize && (
        ...
        <Grid item md={12} xs={12} sx={{ mt: 2 }}>
          ...
          >
            <Slider
              value={[
                propertyState.buyLot.PropFromRange,
                propertyState.buyLot.PropToRange,
              ]}
            ...
            >
              <TextField
                label="Minimum"
                variant="outlined"
                value={propertyState.buyLot.PropFromRange}
                name="PropFromRange"
                onChange={handleInput}
                sx={{ width: "20rem" }}
              />
              ...
              <TextField
                label="Maximum"
                variant="outlined"
                value={propertyState.buyLot.PropToRange}
                name="PropToRange"
                onChange={handleInput}
                sx={{ width: "20rem" }}
              />
        ...
        <Grid container sx={{ gap: 2, placeContent: "center" }}>
          <Grid item xs={12} md={5}>
            ...
            <Select
              ...
              value={propertyState.buyLot.PropCity}
              onChange={handleInput}
              size="md"
              name="PropCity"
              fullWidth
            ...
            {propertyState.buyLot.lot_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {propertyState.buyLot.lot_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Grid item xs={12} md={5}>
            ...
            <TextField
              ...
              value={propertyState.buyLot.PropNeigborhood}
              onChange={handleInput}
              name="PropNeigborhood"
              required
              fullWidth
            />
            {propertyState.buyLot.lot_errs.PropNeigborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {propertyState.buyLot.lot_errs.PropNeigborhood}
              </FormHelperText>
            )}
