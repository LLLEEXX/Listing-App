...
export default function BuyOffice({}) {
  ////////////////////////////////Variables
      ...
      <Grid container sx={{ gap: 2 }}>
        <Grid item md={3} xs={12}>
          ...
          <TextField
            ...
            fullWidth
            required
            value={propertyState.buyOffice.PropPurpose}
            onChange={handleInput}
            name="PropPurpose"
          />
          {propertyState.buyOffice.office_errs.PropPurpose && (
        ...
        <Grid item md={3} xs={12}>
          ...
          <OutlinedInput
            ...
            required
            value={propertyState.buyOffice.PropSize}
            onChange={handleInput}
            name="PropSize"
          />
          {propertyState.buyOffice.office_errs.PropSize && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {propertyState.buyOffice.office_errs.PropSize}
            </FormHelperText>
          )}
        ...
        <Grid item md={12} xs={12} sx={{ mt: 2 }}>
          ...
          >
            <Slider
              value={[
                propertyState.buyOffice.PropFromRange,
                propertyState.buyOffice.PropToRange,
              ]}
            ...
            >
              <TextField
                label="Minimum"
                variant="outlined"
                value={propertyState.buyOffice.PropFromRange}
                name="PropFromRange"
                onChange={handleInput}
              ...
              <TextField
                label="Maximum"
                variant="outlined"
                value={propertyState.buyOffice.PropToRange}
                name="PropToRange"
                onChange={handleInput}
                sx={{ width: { md: "20rem", xs: "10rem" } }}
              />
        ...
        <Grid container sx={{ gap: 2, placeContent: "center" }}>
          <Grid item xs={12} md={5}>
            ...
            <Select
              ...
              value={propertyState.buyOffice.PropCity}
              onChange={handleInput}
              size="md"
              name="PropCity"
              fullWidth
            ...
            {propertyState.buyOffice.office_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {propertyState.buyOffice.office_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Grid item xs={12} md={5}>
            ...
            <TextField
              ...
              value={propertyState.buyOffice.PropNeigborhood}
              onChange={handleInput}
              name="PropNeigborhood"
              required
              fullWidth
            />
            {propertyState.buyOffice.office_errs.PropNeigborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {propertyState.buyOffice.office_errs.PropNeigborhood}
              </FormHelperText>
            )}
