...
export default function RentOffice({}) {
  ...
  return (
    <form onSubmit={rentOffice}>
      <Grid container sx={{ gap: 2 }}>
        <Grid item md={3} xs={12}>
          <InputLabel sx={{ fontWeight: "bold", mb: 1 }}>Purpose:</InputLabel>
          <TextField
            placeholder="Enter Office Purpose"
            variant="outlined"
            fullWidth
            name="PropPurpose"
            onChange={handleInput}
            value={rentPropertyState.rentOffice.PropPurpose}
            required
          />
          {rentPropertyState.rentOffice.office_errs.PropPurpose && (
        ...
        <Grid item md={3} xs={12}>
          ...
          <OutlinedInput
            ...
            name="PropSize"
            onChange={handleInput}
            value={rentPropertyState.rentOffice.PropSize}
            required
          />
          {rentPropertyState.rentOffice.office_errs.PropSize && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentPropertyState.rentOffice.office_errs.PropSize}
            </FormHelperText>
          )}
        ...
        <Grid item md={12} xs={12} sx={{ mt: 2 }}>
          ...
          >
            <Slider
              value={[
                rentPropertyState.rentOffice.PropFromRange,
                rentPropertyState.rentOffice.PropToRange,
              ]}
            ...
            >
              <TextField
                label="Minimum"
                variant="outlined"
                value={rentPropertyState.rentOffice.PropFromRange}
                name="PropFromRange"
                onChange={handleInput}
              ...
              <TextField
                label="Maximum"
                variant="outlined"
                value={rentPropertyState.rentOffice.PropToRange}
                name="PropToRange"
                onChange={handleInput}
                sx={{ width: { md: "20rem", xs: "10rem" } }}
              />
        ...
        <Grid container sx={{ gap: 2, placeContent: "center" }}>
          <Grid item xs={12} md={5}>
            ...
            <Select
              ...
              value={rentPropertyState.rentOffice.PropCity}
              onChange={handleInput}
              size="md"
              name="PropCity"
              fullWidth
            ...
            {rentPropertyState.rentOffice.office_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentPropertyState.rentOffice.office_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Grid item xs={12} md={5}>
            ...
            <TextField
              ...
              value={rentPropertyState.rentOffice.PropNeigborhood}
              onChange={handleInput}
              name="PropNeigborhood"
              required
              fullWidth
            />
            {rentPropertyState.rentOffice.office_errs.PropNeigborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentPropertyState.rentOffice.office_errs.PropNeigborhood}
              </FormHelperText>
            )}
