...
export default function RentWarehouse({}) {
  ...
  const handleInput = (e) => {
    ...
    setRentPropertyState({
      ...rentPropertyState,
      rentWareHouse: {
        ...rentPropertyState.rentWareHouse,
        [name]: value,
      },
    });
  };
      ...
      <Grid container sx={{ gap: 2 }}>
        <Grid item md={3} xs={12}>
          ...
          <TextField
            ...
            variant="outlined"
            fullWidth
            value={rentPropertyState.rentWareHouse.PropPurpose}
            name="PropPurpose"
            required
            onChange={handleInput}
          />
          {rentPropertyState.rentWareHouse.warehouse_errs.PropPurpose && (
        ...
        <Grid item md={3} xs={12}>
          ...
          <OutlinedInput
            ...
            value={rentPropertyState.rentWareHouse.PropSize}
            name="PropSize"
            required
            onChange={handleInput}
          />
          {rentPropertyState.rentWareHouse.warehouse_errs.PropSize && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentPropertyState.rentWareHouse.warehouse_errs.PropSize}
            </FormHelperText>
          )}
        ...
        <Grid item md={12} xs={12} sx={{ mt: 2 }}>
          ...
          >
            <Slider
              value={[
                rentPropertyState.rentWareHouse.PropFromRange,
                rentPropertyState.rentWareHouse.PropToRange,
              ]}
            ...
            >
              <TextField
                label="Minimum"
                variant="outlined"
                value={rentPropertyState.rentWareHouse.PropFromRange}
                name="PropFromRange"
                onChange={handleInput}
              ...
              <TextField
                label="Maximum"
                variant="outlined"
                value={rentPropertyState.rentWareHouse.PropToRange}
                name="PropToRange"
                onChange={handleInput}
                sx={{ width: { md: "20rem", xs: "10rem" } }}
              />
        ...
        <Grid container sx={{ gap: 2, placeContent: "center" }}>
          <Grid item xs={12} md={5}>
            ...
            <Select
              ...
              value={rentPropertyState.rentWareHouse.PropCity}
              onChange={handleInput}
              size="md"
              name="PropCity"
              fullWidth
            ...
            {rentPropertyState.rentWareHouse.warehouse_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentPropertyState.rentWareHouse.warehouse_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Grid item xs={12} md={5}>
            ...
            <TextField
              ...
              value={rentPropertyState.rentWareHouse.PropNeigborhood}
              onChange={handleInput}
              name="PropNeigborhood"
              required
              fullWidth
            />
            {rentPropertyState.rentWareHouse.warehouse_errs.PropNeigborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentPropertyState.rentWareHouse.warehouse_errs.PropNeigborhood}
              </FormHelperText>
            )}
