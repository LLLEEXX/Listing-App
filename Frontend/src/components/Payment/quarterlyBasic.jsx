                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Box sx={{ mt: 3 }}>
                                ...
                                <Typography level="h1" sx={{ fontSize: "40px" }}>₱1,500.00<span style={{ color: "#3d3d3d", fontSize: "14px", letterSpacing: "0.5px" }}>/Quarterly</span></Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" sx={{ fontSize: "16px", mt: 2 }}>Basic Plan Benefits: </Typography>
                            ...
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" startDecorator={<SouthIcon />} sx={{ fontSize: "16px" }}> ₱40,000</Typography>
                                <Typography level="title-md" color='neutral' sx={{ textIndent: "25px", fontSize: "14px" }}>Rental Limit Search</Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" startDecorator={<SouthIcon />} sx={{ fontSize: "16px" }}> ₱5,000,000</Typography>
