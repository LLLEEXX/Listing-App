                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Box sx={{ mt: 3 }}>
                                ...
                                <Typography level="h1" sx={{ fontSize: "40px" }}>₱10,500.00<span style={{ color: "#3d3d3d", fontSize: "14px", letterSpacing: "0.5px" }}>/Quarterly</span></Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" sx={{ fontSize: "16px", mt: 2 }}>Master Plan Benefits: </Typography>
                                <Typography level="h4" sx={{ fontSize: "16px", mt: 2 }}><img src="assets/r-coin.png" style={{ width: "20px", height: "20px" }} /> 90 Red Coins</Typography>
...
export default QuarterlyMaster;