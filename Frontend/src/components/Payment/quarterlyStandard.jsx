                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Box sx={{ mt: 3 }}>
                                ...
                                <Typography level="h1" sx={{ fontSize: "40px" }}>₱3,000.00<span style={{ color: "#3d3d3d", fontSize: "14px", letterSpacing: "0.5px" }}>/Quarterly</span></Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" sx={{ fontSize: "16px", mt: 2 }}>Standard Plan Benefits: </Typography>
                                <Typography level="h4" sx={{ fontSize: "16px", mt: 2 }}><img src="assets/r-coin.png" style={{ width: "20px", height: "20px" }} /> 30 Red Coins</Typography>
                                <Typography level="title-md" color='neutral' sx={{ textIndent: "25px", fontSize: "14px" }}>Rental Listing / Posting</Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" sx={{ fontSize: "16px" }}><img src="assets/s-coin.png" style={{ width: "20px", height: "20px" }} /> 15 Silver Coins</Typography>
                                <Typography level="title-md" color='neutral' sx={{ textIndent: "25px", fontSize: "14px" }}>Sale Listing / Posting</Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" startDecorator={<SouthIcon />} sx={{ fontSize: "16px" }}> ₱60,000</Typography>
                                <Typography level="title-md" color='neutral' sx={{ textIndent: "25px", fontSize: "14px" }}>Rental Limit Search</Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
                                <Typography level="h4" startDecorator={<SouthIcon />} sx={{ fontSize: "16px" }}> ₱10,000,000</Typography>
...
export default QuarterlyStandard;