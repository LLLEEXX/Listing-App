                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Box sx={{ mt: 3 }}>
                                ...
                                <Typography level="h1" sx={{ fontSize: "40px" }}>₱6,000.00<span style={{ color: "#3d3d3d", fontSize: "14px", letterSpacing: "0.5px" }}>/Semi-Annual</span></Typography>
                            </Box>
                            <Box sx={{ mt: 1 }}>
