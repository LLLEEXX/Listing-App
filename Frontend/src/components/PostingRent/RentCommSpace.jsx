...
import { Snackbar, Modal, ModalDialog, ModalClose, Button as ModalButton, Divider,Typography as Joy, } from "@mui/joy";
...
export default function RentCommSpace() {
  ...
  const handleInput = (e) => {
    ...
    setRentCommSpace((prevState) => ({
      ...prevState,
      [name]: value,
    }));
  };

  const [rentCommSpace, setRentCommSpace] = useState({
    PropTitle: "",
    PropDesc: "",
    PropSize: "",
    PropPurpose: "",
  ...
  const RentCommSpace = async (e) => {
    e.preventDefault();
    const formData = new FormData();
    // Add condoInfo data
    for (const [key, value] of Object.entries(rentCommSpace)) {
      ...
      <Grid container sx={{ mb: 2 }}>
        <Grid item xs={12} sx={{ mb: 2 }}>
          ...
          <TextField
            ...
            value={rentCommSpace.PropTitle}
          />
          {rentCommSpace.commSpace_errs.PropTitle && (
        ...
        <Grid item xs={12} sx={{ mb: 2 }}>
          ...
          <TextField
            ...
            name="PropDesc"
            onChange={handleInput}
            value={rentCommSpace.PropDesc}
            required
          />
          {rentCommSpace.commSpace_errs.PropDesc && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentCommSpace.commSpace_errs.PropDesc}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ mb: 3, gap: 2 }}>
        ...
        <Grid item xs={12} md={3}>
          ...
          <TextField
            ...
            name="PropPurpose"
            onChange={handleInput}
            value={rentCommSpace.PropPurpose}
            required
          />
          {rentCommSpace.commSpace_errs.PropPurpose && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentCommSpace.commSpace_errs.PropPurpose}
            </FormHelperText>
          )}
        ...
        <Grid item xs={12} md={1.5}>
          ...
          <OutlinedInput
            ...
            name="PropRate"
            onChange={handleInput}
            value={rentCommSpace.PropRate}
            required
          />
          {rentCommSpace.commSpace_errs.PropRate && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentCommSpace.commSpace_errs.PropRate}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ display: "flex", gap: 3 }}>
        <Grid item xs={12}>
          <Box>
            ...
            <TextField
              ...
              fullWidth
              onChange={handleInput}
              value={rentCommSpace.PropAdd}
            />
            {rentCommSpace.commSpace_errs.PropAdd && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentCommSpace.commSpace_errs.PropAdd}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            {rentCommSpace.commSpace_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentCommSpace.commSpace_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            <TextField
              ...
              value={rentCommSpace.PropNeighborhood}
              onChange={handleInput}
            ...
            {rentCommSpace.commSpace_errs.PropNeighborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentCommSpace.commSpace_errs.PropNeighborhood}
              </FormHelperText>
            )}
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            fullWidth
            onChange={handleInput}
            value={rentCommSpace.PropGoogleLink}
          />
          {rentCommSpace.commSpace_errs.PropGoogleLink && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentCommSpace.commSpace_errs.PropGoogleLink}
            </FormHelperText>
          )}
        </Grid>
        {rentCommSpace && rentCommSpace.PropGoogleLink ? (
          <Grid item md={12} xs={12} sx={{ height: "25rem" }}>
            <iframe
              title="Google Maps"
              src={takeSrc(rentCommSpace.PropGoogleLink)}
