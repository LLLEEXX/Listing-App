...
export default function RentOffice() {
  ...
  const handleInput = (e) => {
    ...
    setRentOffice((prevState) => ({
      ...prevState,
      [name]: value,
    }));
  };

  const [rentOffice, setRentOffice] = useState({
    PropTitle: "",
    PropDesc: "",
    PropOfficeType: "Private Office",
    PropSize: "",
    PropPurpose: "",
    PropRate: "",
    PropAdd: "",
  ...
  const RentOffice = async (e) => {
    e.preventDefault();
    const formData = new FormData();

    // Add condoInfo data
    for (const [key, value] of Object.entries(rentOffice)) {
    ...
    try {
      ...
      const response = await axios.post("/api/post-office", formData, config);
      ...
      <Grid container sx={{ mb: 2 }}>
        ...
        <Grid item xs={12} sx={{ mb: 2 }}>
          ...
          <TextField
            ...
            name="PropDesc"
            onChange={handleInput}
            value={rentOffice.PropDesc}
            required
          />
          {rentOffice.office_errs.PropDesc && (
      ...
      <Grid container sx={{ mb: 3, gap: 2 }}>
        <Grid item xs={12} md={3}>
          ...
          <Select
            id="PropParking"
            fullWidth
            defaultValue={rentOffice.PropOfficeType}
            onChange={handleInput}
          >
            <MenuItem value="Private Office">Private</MenuItem>
            <MenuItem value="Co-Working Office">Co-working Space</MenuItem>
            <MenuItem value="Virtual">Virtual</MenuItem>
            <MenuItem value="Built to Suite Office">
              Built to Suite Offices
            </MenuItem>
          </Select>
        </Grid>
        <Grid item xs={12} md={1}>
          ...
          <OutlinedInput
            ...
            name="PropSize"
            onChange={handleInput}
            value={rentOffice.PropSize}
            required
          />
          {rentOffice.office_errs.PropSize && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentOffice.office_errs.PropSize}
            </FormHelperText>
          )}
        ...
        <Grid item xs={12} md={2.8}>
          ...
          <TextField
            ...
            name="PropPurpose"
            onChange={handleInput}
            value={rentOffice.PropPurpose}
            required
          />
          {rentOffice.office_errs.PropPurpose && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentOffice.office_errs.PropPurpose}
            </FormHelperText>
          )}
        ...
        <Grid item xs={12} md={1.5}>
          ...
          <OutlinedInput
            ...
            name="PropRate"
            onChange={handleInput}
            value={rentOffice.PropRate}
            required
          />
          {rentOffice.office_errs.PropRate && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentOffice.office_errs.PropRate}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ display: "flex", gap: 3 }}>
        <Grid item xs={12}>
          <Box>
            ...
            <TextField
              ...
              fullWidth
              onChange={handleInput}
              value={rentOffice.PropAdd}
            />
            {rentOffice.office_errs.PropAdd && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentOffice.office_errs.PropAdd}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            {rentOffice.office_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentOffice.office_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            <TextField
              ...
              value={rentOffice.PropNeighborhood}
              onChange={handleInput}
            ...
            {rentOffice.office_errs.PropNeighborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {rentOffice.office_errs.PropNeighborhood}
              </FormHelperText>
            )}
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            fullWidth
            onChange={handleInput}
            value={rentOffice.PropGoogleLink}
          />
          {rentOffice.office_errs.PropGoogleLink && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {rentOffice.office_errs.PropGoogleLink}
            </FormHelperText>
          )}
        </Grid>
        {rentOffice && rentOffice.PropGoogleLink ? (
          <Grid item md={12} xs={12} sx={{ height: "25rem" }}>
            <iframe
              title="Google Maps"
              src={takeSrc(rentOffice.PropGoogleLink)}
