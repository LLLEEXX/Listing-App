...
export default function SaleCommSpace() {
  ...
  const [saleCommSpace, setSaleCommSpace] = useState({
    PropTitle: "",
    PropDesc: "",
    PropSize: "",
    PropPurpose: "",
  ...
  const SaleCommSpace = async (e) => {
    e.preventDefault();
    const formData = new FormData();

    // Add condoInfo data
    for (const [key, value] of Object.entries(saleCommSpace)) {
      ...
      <Grid container sx={{ gap: 2 }}>
        ...
        <Grid item md={1} xs={12}>
          ...
          <OutlinedInput
            ...
            name="PropSize"
            value={saleCommSpace.PropSize}
            onChange={handleInput}
            required
          />
          {saleCommSpace.commSpace_errs.PropSize && (
        ...
        <Grid item md={2.8} xs={12}>
          ...
          <TextField
            ...
            name="PropPurpose"
            value={saleCommSpace.PropPurpose}
            onChange={handleInput}
            required
          />
          {saleCommSpace.commSpace_errs.PropPurpose && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleCommSpace.commSpace_errs.PropPurpose}
            </FormHelperText>
          )}
        ...
        <Grid item md={1.5} xs={12}>
          ...
          <OutlinedInput
            ...
            name="PropRate"
            value={saleCommSpace.PropRate}
            onChange={handleInput}
            required
          />
          {saleCommSpace.commSpace_errs.PropRate && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleCommSpace.commSpace_errs.PropRate}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ display: "flex", gap: 3 }}>
        <Grid item xs={12}>
          <Box>
            ...
            <TextField
              ...
              name="PropAdd"
              fullWidth
              value={saleCommSpace.PropAdd}
              onChange={handleInput}
            />
            {saleCommSpace.commSpace_errs.PropAdd && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleCommSpace.commSpace_errs.PropAdd}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            {saleCommSpace.commSpace_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleCommSpace.commSpace_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            <TextField
              ...
              value={saleCommSpace.PropNeighborhood}
              onChange={handleInput}
            ...
            {saleCommSpace.commSpace_errs.PropNeighborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleCommSpace.commSpace_errs.PropNeighborhood}
              </FormHelperText>
            )}
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            fullWidth
            value={saleCommSpace.PropGoogleLink}
            onChange={handleInput}
            required
          />
        </Grid>
        {saleCommSpace && saleCommSpace.PropGoogleLink ? (
          <Grid item md={12} xs={12} sx={{ height: "25rem" }}>
            <iframe
              title="Google Maps"
              src={takeSrc(saleCommSpace.PropGoogleLink)}
