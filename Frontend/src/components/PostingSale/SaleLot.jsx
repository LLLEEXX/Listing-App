...
export default function SaleLot() {
  ...
  const SaleLot = async (e) => {
    e.preventDefault();
    const formData = new FormData();

    // Add condoInfo data
    for (const [key, value] of Object.entries(saleLot)) {
    ...
    try {
      ...
      const response = await axios.post("/api/sale-lot", formData, config);
      ...
      <Grid container sx={{ gap: 2 }}>
        ...
        <Grid item md={3} xs={12}>
          ...
          <TextField
            ...
            required
            name="PropCommVill"
            value={saleLot.PropCommVill}
            onChange={handleInput}
          />
          {saleLot.lot_errs.PropCommVill && (
        ...
        <Grid item md={1} xs={12}>
          ...
          <OutlinedInput
            ...
            required
            name="PropSize"
            value={saleLot.PropSize}
            onChange={handleInput}
          />
          {saleLot.lot_errs.PropSize && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleLot.lot_errs.PropSize}
            </FormHelperText>
          )}
        ...
        <Grid item md={2} xs={12}>
          ...
          <OutlinedInput
            ...
            required
            name="PropRate"
            value={saleLot.PropRate}
            onChange={handleInput}
          />
          {saleLot.lot_errs.PropRate && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleLot.lot_errs.PropRate}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ display: "flex", gap: 3 }}>
        <Grid item xs={12}>
          <Box>
            ...
            <TextField
              ...
              name="PropAdd"
              fullWidth
              value={saleLot.PropAdd}
              onChange={handleInput}
            />
            {saleLot.lot_errs.PropAdd && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleLot.lot_errs.PropAdd}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            <TextField
              ...
              value={saleLot.PropNeighborhood}
              onChange={handleInput}
            ...
            {saleLot.lot_errs.PropNeighborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleLot.lot_errs.PropNeighborhood}
              </FormHelperText>
            )}
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            fullWidth
            value={saleLot.PropGoogleLink}
            onChange={handleInput}
            required
          />
        </Grid>
        {saleLot && saleLot.PropGoogleLink ? (
          <Grid item md={12} xs={12} sx={{ height: "25rem" }}>
            <iframe
              title="Google Maps"
              src={takeSrc(saleLot.PropGoogleLink)}
