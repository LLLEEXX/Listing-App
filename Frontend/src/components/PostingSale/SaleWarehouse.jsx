...
export default function SaleWarehouse() {
  ...
  const handleInput = (e) => {
    ...
    setSaleWareHouse((prevState) => ({
      ...prevState,
      [name]: value,
    }));
  };

  const [saleWareHouse, setSaleWareHouse] = useState({
    PropTitle: "",
    PropDesc: "",
    PropSize: "",
    PropPurpose: "",
  ...
  const SaleWareHouse = async (e) => {
    e.preventDefault();
    const formData = new FormData();

    // Add condoInfo data
    for (const [key, value] of Object.entries(saleWareHouse)) {
      ...
      <Grid container sx={{ gap: 2 }}>
        ...
        <Grid item md={1} xs={12}>
          ...
          <OutlinedInput
            ...
            name="PropSize"
            value={saleWareHouse.PropSize}
            onChange={handleInput}
            required
          />
          {saleWareHouse.wareHouse_errs.PropSize && (
        ...
        <Grid item md={2.8} xs={12}>
          ...
          <TextField
            ...
            name="PropPurpose"
            value={saleWareHouse.PropPurpose}
            onChange={handleInput}
            required
          />
          {saleWareHouse.wareHouse_errs.PropPurpose && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleWareHouse.wareHouse_errs.PropPurpose}
            </FormHelperText>
          )}
        ...
        <Grid item md={1.5} xs={12}>
          ...
          <OutlinedInput
            ...
            name="PropRate"
            value={saleWareHouse.PropRate}
            onChange={handleInput}
            required
          />
          {saleWareHouse.wareHouse_errs.PropRate && (
            <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
              {saleWareHouse.wareHouse_errs.PropRate}
            </FormHelperText>
          )}
      ...
      <Grid container sx={{ display: "flex", gap: 3 }}>
        <Grid item xs={12}>
          <Box>
            ...
            <TextField
              ...
              name="PropAdd"
              fullWidth
              value={saleWareHouse.PropAdd}
              onChange={handleInput}
            />
            {saleWareHouse.wareHouse_errs.PropAdd && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleWareHouse.wareHouse_errs.PropAdd}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            {saleWareHouse.wareHouse_errs.PropCity && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleWareHouse.wareHouse_errs.PropCity}
              </FormHelperText>
            )}
          ...
          <Box>
            ...
            <TextField
              ...
              value={saleWareHouse.PropNeighborhood}
              onChange={handleInput}
            ...
            {saleWareHouse.wareHouse_errs.PropNeighborhood && (
              <FormHelperText sx={{ color: "tomato", fontSize: 13 }}>
                {saleWareHouse.wareHouse_errs.PropNeighborhood}
              </FormHelperText>
            )}
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            fullWidth
            value={saleWareHouse.PropGoogleLink}
            onChange={handleInput}
            required
          />
        </Grid>
        {saleWareHouse && saleWareHouse.PropGoogleLink ? (
          <Grid item md={12} xs={12} sx={{ height: "25rem" }}>
            <iframe
              title="Google Maps"
              src={takeSrc(saleWareHouse.PropGoogleLink)}
